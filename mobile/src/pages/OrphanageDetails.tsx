...
export default function OrphanageDetails() {
   ...
   useEffect(()=>{
     api.get(`/orphanages/${Orphanage.id}`).then(response=>{
       SetOrphanage(response.data);
       console.log('orfanato detalhes',response.data);
     })
   },[Orphanage.id])
    ...
    <ScrollView style={styles.container}>
      <View style={styles.imagesContainer}>
        <ScrollView horizontal pagingEnabled>
          {orphanage?.images.map(orphImages=>(
          <Image key={orphImages.id} style={styles.image} source={{ uri:orphImages.url }} />
          ))}
        </ScrollView>
      </View>
